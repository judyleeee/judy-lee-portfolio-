...
export const metadata: Metadata = {
  title: "어바웃 — Judy Lee",
  description:
    "브랜드 크래프트 DNA를 가진 프로덕트 디자이너. 지금은 AI 네이티브 제품 경험에 집중하고 있습니다.",
};
    ...
    >
      ...
      >
        ...
        <p style={{ marginBottom: "var(--space-4)" }}>
          ...
          시스템 사고와 크래프트, 그리고 새로운 인터랙션 패러다임이 만나는
